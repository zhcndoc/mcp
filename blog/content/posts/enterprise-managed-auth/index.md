...
- **阅读要求：** 
  [企业管理授权页面](https://modelcontextprotocol.io/extensions/auth/enterprise-managed-authorization)
  说明了客户端、服务器和授权服务器的流程。
- **源代码与草案规范：** 查看
  [ext-auth 仓库](https://github.com/modelcontextprotocol/ext-auth) 和
  [草案规范](https://github.com/modelcontextprotocol/ext-auth/blob/main/specification/draft/enterprise-managed-authorization.mdx)
  ，了解 EMA 的最新演进，以及所有能帮助你
  上手的支持材料。
