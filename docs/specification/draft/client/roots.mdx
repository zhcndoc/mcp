...
<Warning>
  **已弃用**：Roots 功能自协议版本
  `DRAFT-2026-v1` 起已被弃用。根据
  [SEP-2596](https://github.com/modelcontextprotocol/modelcontextprotocol/pull/2596) 中概述的弃用政策，它将在 `DRAFT-2026-v1` 发布后 1 年内发布的任何 MCP 版本中继续受支持。
</Warning>
...
sequenceDiagram
    ...
    Client->>Server: tool/call(id: 2, 可用的根目录)
```
