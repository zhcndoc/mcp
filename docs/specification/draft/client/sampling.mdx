...
<Warning>
  **已弃用**：自协议版本 `DRAFT-2026-v1` 起，采样功能已被弃用。根据 [SEP-2596](https://github.com/modelcontextprotocol/modelcontextprotocol/pull/2596) 中概述的弃用策略，在 `DRAFT-2026-v1` 发布后 1 年内发布的任何 MCP 版本中，它将继续得到支持。
</Warning>
