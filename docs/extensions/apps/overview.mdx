...
MCP 应用目前由 [Claude](https://claude.ai)、[Claude Desktop](https://claude.ai/download)、[VS Code GitHub Copilot](https://code.visualstudio.com/)、[Goose](https://block.github.io/goose/)、[Postman](https://postman.com) 和 [MCPJam](https://www.mcpjam.com/) 支持。请参阅 [客户端矩阵](/extensions/client-matrix) 以获取跨客户端的完整扩展支持列表。
