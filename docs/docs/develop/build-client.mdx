...
- 如果相对路径不起作用，请使用绝对路径
- 对于 Windows 用户，请确保在路径中使用正斜杠（/）或转义的反斜杠（\\）
- 验证服务器文件扩展名是否正确（Python 为 .py，Node.js 为 .js 或 Ruby 为 .rb）
...
<CardGroup cols={2}>
  <Card title="Example Servers" icon="grid" href="/examples">
    View our gallery of official MCP servers and implementations
  </Card>
  <Card title="Example Clients" icon="cubes" href="/clients">
    View the list of clients that support MCP integration
  </Card>
</CardGroup>
