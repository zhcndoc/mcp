...
- **开发者**：MCP 可以减少构建或集成 AI 应用程序或智能体时的开发时间和复杂性。
- **AI 应用程序或智能体**：MCP 让它们能够访问由数据源、工具和应用程序组成的生态系统，从而增强其能力并改善终端用户体验。
- **终端用户**：MCP 带来了功能更强大的 AI 应用程序或智能体，它们可以访问用户数据，并在必要时代表用户执行操作。
