...
- **实现工作**：构建 SDK 功能或参考实现（可在 [实验性仓库](https://github.com/modelcontextprotocol/experimental-ext-tool-annotations) 中探索，但这不是 IG 的主要目的）
...
| ----------------------- | ------------ | ---------------------------------------------------- | -------- | ----------- |
| Sam Morrow              | GitHub       | [@SamMorrowDrums](https://github.com/SamMorrowDrums) |          | 促进者 |
| Robert Reichel          | OpenAI       | [@rreichel3](https://github.com/rreichel3)           |          | 促进者 |
...
| Maxi Boch               | 独立         | [@maxiboch](https://github.com/maxiboch)             | maxiboch | 参与者 |
