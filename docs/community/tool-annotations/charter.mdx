...
- **安全 IG** - 信任与敏感性注解（[SEP-1913](https://github.com/modelcontextprotocol/modelcontextprotocol/pull/1913)）涉及双方的关注点
- **[Skills Over MCP WG](/community/skills-over-mcp/charter)** - 技能级元数据可能会与工具注解在发现和过滤方面产生交互
