---
title: "SEP-2468：建议在 MCP Auth 响应中使用 Issuer（iss）参数"
sidebarTitle: "SEP-2468：建议在 MCP…中使用 Issuer（iss）参数"
description: "建议在 MCP Auth 响应中使用 Issuer（iss）参数"
---
...
| ------------- | ------------------------------------------------------------------------------- |
| **SEP**       | 2468                                                                            |
| **标题**      | 建议在 MCP Auth 响应中使用 Issuer（iss）参数                                    |
| **状态**      | 审核中                                                                          |
| **类型**      | 标准跟踪                                                                        |
| **创建时间**  | 2026-03-25                                                                      |
| **作者**      | Emily Lauber ([@EmLauber](https://github.com/EmLauber))                         |
| **赞助人**    | [@pcarleton](https://github.com/pcarleton)                                      |
