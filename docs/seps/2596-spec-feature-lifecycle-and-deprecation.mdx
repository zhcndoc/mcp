...
请注意，本文档中 “Final” 一词有两种含义：当一个规范_修订版_被后续版本取代时，它就是最终版（见版本指南）；而一个 _SEP_ 在其状态按照 [SEP 指南][sep-guidelines]推进后也会达到最终版。语境通常可以消歧；如无法消歧，本文将明确写作“the SEP reaches Final”或“Final revision”。
