...
| ------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **SEP**       | 2106                                                                                                                                                                          |
| **标题**      | 工具 `inputSchema` 与 `outputSchema` 符合 JSON Schema 2020-12                                                                                                               |
| **状态**      | 最终                                                                                                                                                                          |
| **类型**      | 标准轨道                                                                                                                                                                      |
| **创建日期**  | 2026-01-06                                                                                                                                                                    |
| **作者**      | John McBride ([@jpmcb](https://github.com/jpmcb)) — 原始提案；Ola Hungerford ([@olaservo](https://github.com/olaservo)) — 当前维护人，SEP-1850 转换后 |
| **发起人**    | Ola Hungerford ([@olaservo](https://github.com/olaservo))                                                                                                                     |
...
1. **明确的错误信息** 会承认这一限制：
   ...
   ```python
   raise ValueError(
       f"输出 schema 必须表示对象类型，这是 MCP 规范限制所致。"
   )
   ```
