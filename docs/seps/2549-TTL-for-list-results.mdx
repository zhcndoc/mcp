...
| **发起人**    | [@CaitieM20](https://github.com/CaitieM20)                                      |
...
3. **缺少新鲜度信号**：即使可以接收通知的客户端，也无法知道一个列表有多“稳定”。一个工具列表每天变化一次的服务器，与一个每秒变化一次的服务器，对客户端来说看起来是一样的——两者都只是在发生变化时发送通知。TTL 提供了明确的新鲜度提示。
